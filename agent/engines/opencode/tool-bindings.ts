...
export const OPENCODE_TOOL_BINDINGS = [
  ...
  ['def.timeline.preview', 'def_timeline_preview'],
  ['def.timeline.apply_prepared', 'def_timeline_apply_prepared'],
  ['def.timeline.reject_preview', 'def_timeline_reject_preview'],
  ['def.timeline.revise_preview', 'def_timeline_revise_preview'],
