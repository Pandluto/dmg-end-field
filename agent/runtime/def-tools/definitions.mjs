...
export const DEF_TOOL_DEFINITION_BASE = Object.freeze([
  ...
  { name: 'def.equipment.resolve', scope: 'read', riskLevel: 'read', approval: 'none', status: 'implemented', description: 'Resolve stable equipment ids and gear sets from the same complete library as Operator Config; supports bounded batch and ASR-tolerant ranked candidates.' },
