...
export const operator_config_patch = {
  ...
  args: {
    ...
    gearSetName: tool.schema.string().optional().describe('Exact equipment set name from DEF equipment resource; preview blocks rather than substituting if the Operator Configuration library lacks it.'),
    gearSetId: tool.schema.string().optional().describe('Exact equipment set id from DEF equipment resource; preview blocks rather than substituting if the Operator Configuration library lacks it.'),
    equipmentName: tool.schema.string().optional().describe('Exact single equipment name from DEF equipment resource; preview independently verifies it in the Operator Configuration library.'),
    equipmentId: tool.schema.string().optional().describe('Exact single equipment id from DEF equipment resource; preview independently verifies it in the Operator Configuration library.'),
