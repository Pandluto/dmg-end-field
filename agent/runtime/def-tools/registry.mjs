...
export const DEF_NATIVE_TARGETS = Object.freeze([
  ...
  { id: 'def.team.selection.apply', family: DEF_TOOL_FAMILY.NODE_CRUD, source: 'def-native', nativeBinding: 'def_team_selection_apply', status: 'implemented', workspaceScope: 'current-checkout', exposure: ['workbench'] },
