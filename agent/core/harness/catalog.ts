...
const askOperation = {
  ...
  phases: [
    ...
    },
    {
      ...
      writes: [],
      instructions: 'The user answered the clarification. Route the original request again using that answer and continue the requested business task; do not stop after merely repeating the answer.',
      onSuccess: 'done',
      onFailure: 'failed',
    },
    terminalCompleted,
...
export const PHASE6_INTERACTIVE_HARNESS_CATALOG = [
  ...
  },
  {
    ...
    operations: [
      ...
      singleToolOperation({
        ...
        writes: ['timeline.buttons', 'timeline.work-node', 'timeline.checkout'],
        instructions: 'Add exactly one unambiguous skill button through one isolated validated Work Node. Explicit approval is mandatory.',
      }),
      ...
      singleToolOperation({
        ...
        writes: ['timeline.resistance', 'timeline.work-node', 'timeline.checkout'],
        instructions: 'Set one exact button resistance map through one isolated validated Work Node. Explicit approval is mandatory.',
      }),
      askOperation,
    ],
  },
  {
    ...
    writeScope: ['timeline.buffs', 'timeline.work-node', 'timeline.checkout'],
    operations: [
      ...
      singleToolOperation({
        ...
        writes: ['timeline.buffs', 'timeline.work-node', 'timeline.checkout'],
        instructions: 'Attach one complete Buff through one isolated validated Work Node. Explicit approval is mandatory.',
      }),
      singleToolOperation({
        operation: 'remove',
        phaseId: 'remove-buff',
        ...
        writes: ['timeline.buffs', 'timeline.work-node', 'timeline.checkout'],
        instructions: 'Remove one exact Buff through one isolated validated Work Node. Explicit approval is mandatory.',
      }),
      askOperation,
    ],
  },
  ...
  },
  {
    ...
    displayName: '直接对话',
    sourceLineage: 'conversation@v1',
    revision: 'v1-native-response',
