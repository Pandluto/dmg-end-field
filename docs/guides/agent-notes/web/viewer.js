const glossary = [
  ...
  ["Context", ["Context"], "上下文", "严格来说，Context 是模型在一次推理中实际收到的全部 tokens，包括消息、系统指令、Tool 定义、Tool Result 和按需加载的材料。", "DEF 每轮组合稳定规则、当前任务、产品坐标和按需知识。", "Session 保存发生过什么；Context 只表示这一刻送给模型什么。"],
