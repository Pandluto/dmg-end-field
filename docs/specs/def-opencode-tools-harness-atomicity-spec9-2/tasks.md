...
| --- | --- | --- | --- |
| 1 | [ ] | 无 | 旧规则迁移清单、硬合同保护 |
| 2 | [ ] | 1 | 唯一 `prepareWorkbenchTurn()` 接缝 |
| 3 | [ ] | 1、2 | 新链路专用的最小 Host/Tool contract |
| 4 | [ ] | 2 | 五业务 Registry 和单业务 Revision Controller |
| 5 | [ ] | 4 | route state、业务选择和跨业务 Plan |
| 6 | [ ] | 2、4、5 | 可恢复的业务事务与真实上下文 |
| 7 | [ ] | 4、5、6 | route/business phase runtime 和动态 Tool |
| 8 | [ ] | 6、7 | 写入隔离、提交协调和下游状态 |
| 9 | [ ] | 4—8 | selection V1 |
| 10 | [ ] | 4—8 | loadout V1 |
| 11 | [ ] | 4—8 | timeline V1 |
| 12 | [ ] | 4—8 | buff V1 |
| 13 | [ ] | 4—8 | calculation V1 |
| 14 | [ ] | 1—13 | 单一正式主链路 |
| 15 | [ ] | 14 | 可交付证据 |
