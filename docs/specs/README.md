...
7. [Spec 8 占位与索引](./def-opencode-cognitive-runtime-spec8/README.md)
   - [Spec 8-1：可训练基建总览](./def-opencode-cognitive-runtime-spec8/spec8-1.md)
     - [Spec 8-1-1：Runtime Harness 与真实黑盒基线](./def-opencode-cognitive-runtime-spec8/spec8-1-1.md)
     - [Spec 8-1-2：Teacher Harness 与独立验证](./def-opencode-cognitive-runtime-spec8/spec8-1-2.md)
     - [Spec 8-1-3：最小知识入口与训练就绪闭环](./def-opencode-cognitive-runtime-spec8/spec8-1-3.md)
   - [Spec 8-2：受控训练](./def-opencode-cognitive-runtime-spec8/spec8-2.md)
