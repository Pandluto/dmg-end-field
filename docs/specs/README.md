...
7. [Spec 8 占位与索引](./def-opencode-cognitive-runtime-spec8/README.md)
   ...
   - [Spec 8-2-3：DEF 受控本地资料原生检索桥接](./def-opencode-cognitive-runtime-spec8/spec8-2-3.md)
     - [Research 8-2-3：受控本地资料到 OpenCode 原生检索的桥接](./def-opencode-cognitive-runtime-spec8/research8-2-3-native-retrieval-bridge.md)
     - [Task 8-2-3：物化受控资料并启用 OpenCode 原生检索](./def-opencode-cognitive-runtime-spec8/task8-2-3.md)
...
9. [Spec 9-2：五业务原子 Harness 解耦、管理与热重载重构](./def-opencode-tools-harness-atomicity-spec9-2/spec.md)
