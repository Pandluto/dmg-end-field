...
const allowedAgentFiles = new Set([
  ...
  'agent/core/contracts/prepared-work-node.ts',
  'agent/core/contracts/product.ts',
  'agent/core/contracts/session.ts',
  'agent/core/contracts/tool.ts',
  'agent/core/harness/catalog.ts',
  'agent/core/harness/deterministic-router.test.ts',
  'agent/core/harness/deterministic-router.ts',
  ...
  'agent/core/interactions/prepared-capability.contract.test.ts',
  ...
  'agent/core/tools/damage-report-operations.test.ts',
  'agent/core/tools/damage-report-operations.ts',
  'agent/core/tools/interactive-workbench.contract.test.ts',
  'agent/core/tools/loadout-fact-operations.test.ts',
  'agent/core/tools/loadout-fact-operations.ts',
  'agent/core/tools/operation-capability.test.ts',
  'agent/core/tools/operation-capability.ts',
...
const thinShellElectronFiles = new Set([
  ...
  'electron/agent-provider-transaction.cjs',
