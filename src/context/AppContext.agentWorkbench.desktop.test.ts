...
assert.match(publishSource, /assertSelectionWorkspaceCheckoutPublishable\(\{/);
assert.match(publishSource, /sourcePayload: source\.payload/);
assert.match(publishSource, /storedCharacterIds: storedIds/);
assert.match(publishSource, /currentCharacterIds: currentIds/);
