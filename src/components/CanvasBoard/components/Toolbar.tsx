 ...
 */
export function Toolbar({ staffCount, onBack, onAddGroup, onRemoveGroup, onSave }: ToolbarProps) {
  return (
    <div className="toolbar">
      ...
      <div className="toolbar-right">
        ...
        <button className="btn-calculate">计算伤害</button>
      </div>
    </div>
  );
}
