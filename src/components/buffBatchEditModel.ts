...
export interface RuntimeSkillResolverInput {
  ...
  skillIconUrl?: string;
  customHits?: SkillButtonData['customHits'];
  element?: string;
}
...
export type RuntimeSkillResolver = (
  input: RuntimeSkillResolverInput,
) => RuntimeSkillProjection | null;
...
interface ProjectVisualSkillButtonsInput {
  ...
  resolveRuntimeSkill?: RuntimeSkillResolver;
  resolveSkillIconUrl?: (characterName: string, skillType: SkillType) => string;
}
...
export function projectVisualSkillButtons({
  ...
  timelineData.staffLines.forEach((staffLine) => {
    ...
    timelineButtons.forEach((timelineButton: SkillButtonData) => {
      ...
      const resolvedRuntimeSkill = resolveRuntimeSkill?.({
