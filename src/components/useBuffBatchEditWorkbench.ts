...
function resolveRuntimeSkill(input: RuntimeSkillResolverInput) {
  return resolveRuntimeTemplateSkill({
    ...input,
    isDragging: false,
    isSelected: false,
    isFromSandbox: true,
...
function getCharacterWeaponName(
  character: Character,
  inputMap: ReturnType<typeof getCharacterInputMap>,
): string {
