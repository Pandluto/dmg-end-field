    ...
    return jsonResponse(200, {
      ...
      mainWorkbenchControl: {
        ...
        rules: [
          ...
          'For risky/batch/timeline rewrite operations, prefer appdata AI work node flow: createAiTimelineWorkNodeFromCurrent -> diffAiTimelineWorkNode -> checkoutAiTimelineWorkNode; use restoreAiTimelineWorkNodeBase for node rollback.',
